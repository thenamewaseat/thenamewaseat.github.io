...
(function (w, d, u) {
        ...
        if (linguJSON) {
            ...
            if (languages.length > 1) {
                ...
                if (!linguJSON.translated_pages) {
                    isTranslated = true;
                    if (!d.getElementById('lingumania_langswitcher')) {
    ...
    w.retranslateLingumania = translateDOM;
}(window, document));